...
module "pi_configure_network_services" {
  ...
  provisioner_remote_exec_inline_pre_exec_commands  = local.pi_configure_network_services.provisioner_remote_exec_inline_pre_exec_commands
  provisioner_file_1                                = local.pi_configure_network_services.provisioner_file_1
  provisioner_file_2                                = local.pi_configure_network_services.provisioner_file_2
  provisioner_remote_exec_inline_post_exec_commands = local.pi_configure_network_services.provisioner_remote_exec_inline_post_exec_commands
}
